...
In my next post, I will do a walkthrough of the code, and go into detail on the steps I took to get Decision Genie to its current state. The GitHub repo can be found [here](https://github.com/hibyrandai/Decision_Genie/blob/master/index.js) if you'd like to explore further.