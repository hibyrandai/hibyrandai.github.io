...
This is intended to be a short and sweet post of what I've had to do so far to set up this company, roughly in chronological order. I put it as a "Part 1" because I thought it would be interesting to lend some transparency into the steps I took to set up the company. YMMV and this experience should not be taken as a universal model, but I hope some insight can be gleaned from what has felt like a never-ending conveyor belt of forms to fill and fees to pay:  <br><br/>
